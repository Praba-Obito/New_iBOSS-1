...
const columns = [
    ...
    { id: "DeletedBy", label: "Deleted By", maxwidth: "200px" },
    { id: "DeletedOn", label: "Deleted On", maxwidth: "auto" },
                    ...
                    <TableHead >
                        <TableRow style={{ backgroundColor: "#f5f5f5" }}>
                            {columns.map((column, index) => (
                                <TableCell key={column.id} align="center" style={{ padding: "12px", textAlign: 'start' }}>
                                    {column.label}
                                </TableCell>
                            ))}
                        </TableRow>
