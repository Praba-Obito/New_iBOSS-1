...
const FinancialInfoTab = ({ value, setValue }) => {
      ...
      >
        ...
        >
          <h6
            ...
            onClick={() => setFinancialInfo(!FinancialInfo)}
          >
            {FinancialInfo ? (
              <ArrowDropDownIcon
        ...
        >
          <h6
            style={{ cursor: "pointer", margin: "0px", color: "#22668d" }}
            onClick={() => setPolicyValue(!PolicyValue)}
          >
            {PolicyValue ? (
              <ArrowDropDownIcon
                style={{ width: "32px", height: "32px", marginBottom: "3px" }}
